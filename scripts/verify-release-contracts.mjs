...
assertContract(mondayItemMasterSync.includes("classifyBoardOnlyBatch") && mondayItemMasterSync.includes('"Missing Canix ID"') && mondayItemMasterSync.includes('"Canix Item ID"'), "legacy Monday-only products receive a distinct missing-Canix-identity grouping after source reconciliation");
