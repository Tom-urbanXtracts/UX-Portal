...
assertContract(admin.includes('action === "remove-test-user"') && admin.includes("testDemoReason") && admin.includes("deleteUser(") && source.includes("Remove test user"), "test-user removal is administrator-only, server-classified, soft-deleted, and separately exposed");
