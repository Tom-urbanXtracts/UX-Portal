...
assertContract(source.includes("demo-onboarding-complete") && source.includes("demo-retailer-001") && source.includes("three qualified stores") && source.includes("isolated test order"), "the executive demo includes a complete isolated three-store onboarding record");
