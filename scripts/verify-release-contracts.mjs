...
assertContract(mondayItemMasterSync.includes('"existing_id" | "created"') && mondayItemMasterSync.includes('targetGroupId') && mondayItemMasterSync.includes('move_item_to_group') && mondayItemMasterMigration.includes('monday_item_master_link'), "Monday Item Master writes are ID-only, idempotent, and keep physical groups current");
