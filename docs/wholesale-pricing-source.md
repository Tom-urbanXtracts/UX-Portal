...
The source is ready for staged ingestion. Bulk publication is intentionally blocked until the 107 review-required rows receive Canix item IDs or the source sheet adds an immutable Canix Item ID column.
