...
- Supabase migrations are reconciled through `20260901320000`; all 15 Edge Functions are active and the 103-contract remote suite, including anonymous-denial checks, passes.
