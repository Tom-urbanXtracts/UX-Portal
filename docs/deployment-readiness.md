...
- Supabase migrations are reconciled through `20260901290000`; all 15 Edge Functions are active and the 66-contract remote suite, including anonymous-denial checks, passes.
